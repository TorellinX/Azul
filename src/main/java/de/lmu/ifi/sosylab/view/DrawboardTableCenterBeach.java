 ...
 */
public class DrawboardTableCenterBeach extends JPanel {
   ...
   */
  public DrawboardTableCenterBeach(GameModel model, Controller controller, int playerNumber) {
    if (playerNumber > 2) {
  ...
  public void drawBeachBackground(Graphics2D g2D){
    ...
    try {
      classLoader = Class.forName("de.lmu.ifi.sosylab.view.DrawboardTableCenterBeach").getClassLoader();
